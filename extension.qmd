...
# Calculate required vaccination rate for 90% coverage in 14 days
target_coverage <- 0.9
vacc_duration <- 14
rho_calc <- -log(1 - target_coverage) / vacc_duration
...
# With vaccination (starting at day 30)
sim_vax <- run_sir_vaccination(
    N = params$N, I0 = params$I0, R0 = params$R0, gamma = params$gamma,
    rho = params$rho, vacc_start = 30, vacc_duration = params$vacc_duration, ve = params$ve
)
