...
plt_tradeoff <- ggplot(d_tradeoff, aes(x = week, y = `No vacc`)) +
    ...
    annotate("text",
        ...
        label = "Impact of vaccination decreases", size = text_size * 1.2, color = "firebrick"
    ) +
    ...
    annotate("text",
        ...
        size = text_size * 1.2, color = "steelblue"
    ) +
    # --- Foreshadowing Intervention Windows ---
    # Pre-emptive window
    geom_segment(aes(x = -5, xend = -5, y = 0, yend = arrow_y_1 - 20), linetype = "dotted", color = "darkred", linewidth = 1) +
    annotate("text", x = -5.5, y = arrow_y_1 - 20, label = "Pre-emptive\nWindow", hjust = 1, size = text_size, color = "darkred") +
    # Reactive window
    geom_segment(aes(x = 5, xend = 5, y = 0, yend = arrow_y_1 - 20), linetype = "dotted", color = "steelblue", linewidth = 1) +
    annotate("text",
        x = 5.5, y = arrow_y_1 - 20, label = "Reactive\nWindow",
        hjust = 0, size = text_size, color = "steelblue"
    ) +
